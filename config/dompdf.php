...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Do not enable this if you're using DOMPDF in a context where remote files 
         ...
         *
         * If this setting is set to true, DOMPDF will automatically load font files
         * from "font_dir"
         */
        'autoload_fonts' => true,

        /**
         * Disable image processing functionality to fix the GD extension requirement
         * If true, won't try to process images
         */
        'disable_image_processing' => !extension_loaded('gd'),
