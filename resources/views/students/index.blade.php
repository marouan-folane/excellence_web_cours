...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('students.near-expiry') }}" class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-md hover:bg-yellow-700 transition-colors">
        ...
        <form action="{{ route('students.index') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="niveau_scolaire" id="niveau_scolaire" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <option value="2_first_middle_niveau" {{ request('niveau_scolaire') == '2_first_middle_niveau' ? 'selected' : '' }}>2ème Niveau Collège</option>
                    <option value="3ac" {{ request('niveau_scolaire') == '3ac' ? 'selected' : '' }}>3éme Année Collège</option>
                    <option value="high_school" {{ request('niveau_scolaire') == 'high_school' ? 'selected' : '' }}>Lycée</option>
                </select>
            </div>
            <div>
