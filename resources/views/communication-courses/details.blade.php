            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('communication-courses.index') }}" class="btn btn-sm btn-secondary">
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($course->prix ?? 150, 2) }} DH</td>
                                </tr>
                                <tr>
                                    <th class="bg-light">
                                        @if(session('locale') == 'fr')
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <div>
                                        @if(session('locale') == 'fr')
                                            <strong>Revenu mensuel estimé:</strong> {{ number_format(count($enrolledStudents) * ($course->prix ?? 150), 2) }} DH
                                        @elseif(session('locale') == 'ar')
                                            <strong>الدخل الشهري المقدر:</strong> {{ number_format(count($enrolledStudents) * ($course->prix ?? 150), 2) }} DH
                                        @else
                                            <strong>Estimated monthly revenue:</strong> {{ number_format(count($enrolledStudents) * ($course->prix ?? 150), 2) }} DH
                                        @endif
                                    </div>
                                </div>
                            </div>
