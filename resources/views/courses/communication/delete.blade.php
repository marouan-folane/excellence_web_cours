    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h1 class="text-2xl font-bold text-gray-800">Delete Communication Course</h1>
            </div>

            <div class="p-6">
                <p class="text-gray-600 mb-4">Are you sure you want to delete the communication course "{{ $course->name }}"? This action cannot be undone.</p>
                ...
                <div class="bg-gray-50 p-4 rounded-md mb-6">
                    ...
                    <dl class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $course->duration }} hours</dd>
                        </div>
                    </dl>
                </div>

                <form action="{{ route('communication.destroy', $course->id) }}" method="POST" class="flex justify-end space-x-4">
                    @csrf
                    @method('DELETE')
